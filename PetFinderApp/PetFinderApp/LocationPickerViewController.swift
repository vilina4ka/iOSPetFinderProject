...
final class LocationPickerViewController: UIViewController, YMKMapInputListener, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(
                title: "Отмена",
                style: .plain, // .plain делает ее обычной текстовой кнопкой
                target: self,
    ...
    @objc private func showButtonTapped() {
        let newLocation = SavedLocation(latitude: selectedPoint.latitude, longitude: selectedPoint.longitude, radius: selectedRadius, address: self.selectedAddress)
